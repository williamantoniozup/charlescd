...
export const authRequest = async (
  ...
  const response = await fetch(`${authPath}${url}`, defaultsDeep(mergedOptions, options));
...
export const unauthenticatedRequest = async (
  ...
  const mergedOptions = defaultsDeep(options, defaultOptions);
  const response = await fetch(`${basePath}${url}`, defaultsDeep(mergedOptions, options));
...
export const baseRequest = (
  ...
  return fetch(`${basePath}${url}`, defaultsDeep(mergedOptions, options)).then(
    (response: Response) => {
      if (!response.ok) {
