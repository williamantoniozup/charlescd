...
type GenericProvider struct {
	...
	CAData            string `json:"caData" yaml:"ca_data"`
	ClientCertificate string `json:"clientCertificate" yaml:"client_certificate"`
	ClientKey         string `json:"clientKey" yaml:"client_key"`
}
