...
import (
	"installer/pkg/cloudprovider/eks"
	"installer/pkg/cloudprovider/generic"
	"installer/pkg/cloudprovider/incluster"
	"installer/pkg/cloudprovider/outofcluster"
	"os"
...
type Cloudprovider struct {
	...
	eks.EKSProvider         `yaml:",inline"`
	generic.GenericProvider `yaml:",inline"`
}
