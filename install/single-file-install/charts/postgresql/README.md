...
| `master.extrainitContainer`                  | Additional init containers to add to the pods (postgresql master)                                                                                                         | `[]`                                                          |
...
| `slave.extrainitContainer`                   | Additional init containers to add to the pods (postgresql slave)                                                                                                          | `[]`                                                          |
