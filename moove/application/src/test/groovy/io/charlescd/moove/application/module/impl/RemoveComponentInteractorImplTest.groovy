...
class RemoveComponentInteractorImplTest extends Specification {
    ...
    def "should remove only the component sent in the request from module"() {
        ...
        def componentOne = new Component(componentOneId, moduleId, "Application", LocalDateTime.now(), workspaceId, 10, 10, 'host', 'gateway', 'namespace')
        def componentTwo = new Component(componentTwoId, moduleId, "Batch-Application", LocalDateTime.now(), workspaceId, 10, 10, 'host', 'gateway', 'namespace')
    ...
    def "should throw an exception when component doest not exist"() {
        ...
        def componentOne = new Component("afd9d0ae-a0f4-4b78-86b1-24baf1270e8c", moduleId, "Batch-Application", LocalDateTime.now(), workspaceId,
                10, 10, 'host', 'gateway', 'namespace')
